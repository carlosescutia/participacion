<main role="main" class="ml-sm-auto px-4 mb-3 col-print-12">
        ...
        <div class="col-sm-12 alternate-color">
            <div class="row">
                <div class="col-sm-8 text-left">
                    <h1 class="h2">Reporte de Acuerdos</h1>
                </div>
    ...
    <div class="col-sm-8" style="min-height: 46vh">
        <?php include 'reporte_totales_acuerdos_status.php' ?>
        <?php include 'reporte_totales_acuerdos_responsable.php' ?>
        <?php include 'reporte_totales_acuerdos_total.php' ?>
    </div>
